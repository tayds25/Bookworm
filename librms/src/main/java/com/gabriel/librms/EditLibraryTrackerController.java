...
public class EditLibraryTrackerController extends GenericLibraryTrackerController {
	...
	public void onSubmit(ActionEvent actionEvent) {
		try {
			...
			LibraryTracker newLibraryTracker = LibraryTrackerService.getService().update(libraryTracker);
